...
public sealed class UpdateMatchUseCase(
    IMatchRepository matchRepository,
    IMapper mapper)
    : IUpdateMatchUseCase
{
    public async Task ExecuteAsync(string matchId, MatchUpdateDto matchUpdateDto, CancellationToken cancellationToken)
    {
        ...
        mapper.Map(matchUpdateDto, match);
