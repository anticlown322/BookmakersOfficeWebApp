...
public sealed class GetAllBetsQueryHandler(
    ...
    IMapper mapper)
    : IRequestHandler<GetAllBetsQuery, PagedResponse<IEnumerable<BetDto>>>
{
    public async Task<PagedResponse<IEnumerable<BetDto>>> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var betsDto = betsPagedList.Select(mapper.Map<BetDto>);

        return new PagedResponse<IEnumerable<BetDto>>(
            betsDto,
